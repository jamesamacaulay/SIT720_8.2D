...
st.set_page_config(page_title='House Price Demo', layout='wide')
...
st.write('by James Macaulay, s225294467')
st.write('Enter property details and get a predicted price. This demo uses my tuned Random Forest pipeline.')
